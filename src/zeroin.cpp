...
double zeroin(double ax, double bx, double (*f)(double x, void* extra), double tol, void* extra)	 /* An estimate to the root	*/
...
/* double tol;				 Acceptable tolerance		*/
{
  ...
  a = ax;  b = bx;  fa = (*f)(a, extra);  fb = (*f)(b, extra);
  c = a;   fc = fa;
  ...
  for(;;)		/* Main iteration loop	*/
  {
    ...
    b += new_step;  fb = (*f)(b, extra);   /* Do step to a new approxim.	*/
    // cout<<"zeroin: f("<<b<<") = "<<fb<<"\n";
